    ...
    <FooterContainer>
      <FooterSection>
        <FooterTop>
          ...
          <FooterListUl>
            <FooterListLi><FooterLink href="#">Litepaper</FooterLink></FooterListLi>
            <FooterListLi><FooterLink href="#">Docs</FooterLink></FooterListLi>
            <FooterListLi><FooterLink href="#">Partnerships</FooterLink></FooterListLi>
          </FooterListUl>
          <FooterListUl>
            <FooterListLi><FooterLink href="#">Careers</FooterLink></FooterListLi>
            <FooterListLi><FooterLink href="#">Blog</FooterLink></FooterListLi>
            <FooterListLi><FooterLink href="#">Sponsors</FooterLink></FooterListLi>
        ...
        <FooterBottom>
          <div><LogoLink href="#"><LogoImg src="/images/header/logo-kosu.svg"/></LogoLink></div>
